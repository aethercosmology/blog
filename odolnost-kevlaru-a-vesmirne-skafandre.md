...
| **Rok**       | **Typ materiálu** | **Technológia**              | **Hrúbka (mm)** | **Hranicná rýchlosť nárazu (m/s)** | **Poznámky**                             |
|---------------|-------------------|------------------------------|-----------------|-------------------------------------|-----------------------------------------|
...
| **Typ meteoroidu**   | **Priemer (mm)** | **Rýchlosť (m/s)** | **Sila nárazu (N)** | **Nutná hrúbka kevlarovej ochrany (mm)** |
|----------------------|------------------|---------------------|----------------------|-----------------------------------------|
